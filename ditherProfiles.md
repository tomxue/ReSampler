...
<table>
    ...
    <tbody>
        ...
        <tr><td>2</td><td>flat tpdf (with error-correction feedback)</td><td>gentle highpass response (ie <b>blue noise</b>)</td><td>error correction feedback loop results in first-order (6dB/oct) magnitude response (<b>blue tpdf noise</b>)</td></tr>
