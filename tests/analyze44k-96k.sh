...
$resampler_path -i ./outputs/44khz_sweep-3dBFS_32f-to96k-dp-stage1.wav -o ./outputs/44khz_sweep-3dBFS_32f-to96k-dp-stage2.wav -r 84000 --doubleprecision --lpf-cutoff 54.545455 --lpf-transition 74.772727 --maxStages 1
$resampler_path -i ./outputs/44khz_sweep-3dBFS_32f-to96k-dp-stage2.wav -o ./outputs/44khz_sweep-3dBFS_32f-to96k-dp.wav -r 96000 --doubleprecision --lpf-cutoff 47.727273 --lpf-transition 45.738636 --maxStages 1