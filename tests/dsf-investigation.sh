...
$resampler_path --single-stage -i /Users/newuser/sweep-176400hz-0-22050hz-20s-D64-2.8mhz.dsf -o ./outputs/96khz_sweep-3dBFS_32f-to44k-dp-stage1.wav -r 705600 --doubleprecision --lpf-cutoff 5.681818 --lpf-transition 94.318182 --maxStages 1
$resampler_path --single-stage -i ./outputs/96khz_sweep-3dBFS_32f-to44k-dp-stage1.wav -o ./outputs/96khz_sweep-3dBFS_32f-to44k-dp-stage2.wav -r 176400 --doubleprecision --lpf-cutoff 22.727273 --lpf-transition 77.272727 --maxStages 1
$resampler_path --single-stage -i ./outputs/96khz_sweep-3dBFS_32f-to44k-dp-stage2.wav -o ./outputs/96khz_sweep-3dBFS_32f-to44k-dp.wav -r 44100 --doubleprecision --lpf-cutoff 90.909091 --lpf-transition 9.090909 --maxStages 1
